...
#    [modes]="FULL QUICK"
#)
declare -A test_scenario01=(
    [name]="01-oidc_auth_code_redirect_without_consent"
...
declare -A test_scenario02=(
    [name]="02-oidc_auth_code_redirect_without_consent_retrieve_user_attributes"
...
declare -A test_scenario3=(
   [name]="03-oauth_client_credential_grant"
...
declare -A test_scenario04=(
    [name]="04-oidc_auth_code_redirect_without_consent_retrieve_user_attributes_and_groups"
...
declare -A test_scenario05=(
    [name]="05-oidc_auth_code_redirect_without_consent_retrieve_user_attributes_groups_and_roles"
...
declare -A test_scenario12=(
   [name]="12-B2B_oidc_auth_code_redirect_with_consent"
