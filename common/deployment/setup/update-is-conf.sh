...
#sudo sed -i 's|securerandom.strongAlgorithms=NativePRNGBlocking:SUN,DRBG:SUN|securerandom.strongAlgorithms=NativePRNGNonBlocking:SUN,DRBG:SUN|' $JAVA_HOME/conf/security/java.security
#
